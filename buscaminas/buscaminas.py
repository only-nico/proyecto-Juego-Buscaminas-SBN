...
class BuscaminasGUI:
    def __init__(self, juego):
        ...
        self.colors = {
            -1: (255, 0, 0),   # Mina (rojo)
            0: (255, 255, 0),  # Cero (amarillo)
            1: (0, 0, 255),    # Número 1 (azul)
            # Añade más colores para los números restantes según sea necesario
        }
...
class PantallaInicial:
    def __init__(self):
        ...
        self.opciones = ["Fácil", "Intermedio", "Difícil"]
